...
class ItemMyRateCard extends StatefulWidget {
  ...
  @override
  _ItemMyRateCardState createState() => _ItemMyRateCardState(
        rateHW,
        rateLesson,
        rateStu,
        rateContent,
...
class _ItemMyRateCardState extends State<ItemMyRateCard> {
  final String rateHW, rateLesson, rateStu, rateContent;
  final int rateScore, rateHWState;

  bool _folded = true;

  _ItemMyRateCardState(
    this.rateHW,
    this.rateLesson,
    this.rateStu,
    this.rateContent,
